...
export default function RemontSamsungKaluga() {
  return (
    <RepairLanding config={{
      ...
      keywords: "ремонт Samsung Калуга, ремонт Samsung Galaxy Калуга, замена экрана Samsung Калуга, замена аккумулятора Samsung Калуга, снятие FRP Samsung Калуга, ремонт Galaxy Fold Flip Калуга, сервис Samsung Кирова",
      serviceName: "Ремонт Samsung в Калуге",
      serviceDesc: "Ремонт Samsung Galaxy любой серии в Калуге: замена экрана, аккумулятора, стекла, снятие FRP, ремонт после воды. Гарантия.",
      minPrice: "490",
