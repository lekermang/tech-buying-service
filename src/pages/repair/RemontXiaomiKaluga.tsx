...
export default function RemontXiaomiKaluga() {
  return (
    <RepairLanding config={{
      ...
      keywords: "ремонт Xiaomi Калуга, ремонт Redmi Калуга, ремонт POCO Калуга, замена экрана Xiaomi Калуга, снятие FRP Mi аккаунт Калуга, ремонт Redmi Note Калуга, сервис Xiaomi Кирова",
      serviceName: "Ремонт Xiaomi в Калуге",
      serviceDesc: "Ремонт Xiaomi, Redmi, POCO любой серии в Калуге: замена экрана, аккумулятора, снятие FRP и Mi-аккаунта, ремонт после воды.",
      minPrice: "490",
