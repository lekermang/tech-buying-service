...
interface AncientCoinsCtaProps {
  phone: string;
...
const AncientCoinsCta = ({ phone, setPhone, sent, handleSend, formOpen, setFormOpen }: AncientCoinsCtaProps) => {
  return (
    <>
      {/* ══ CTA БЛОК ══ */}
        ...
        <div className="relative max-w-2xl mx-auto px-4 text-center">
          ...
          {!sent ? (
            <div className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
              ...
              />
              <button onClick={handleSend} className="bg-[#FFD700] text-black font-oswald font-bold text-sm uppercase px-6 py-3 hover:bg-yellow-400 transition-colors whitespace-nowrap flex items-center gap-2">
          ...
          <div className="mt-4 flex items-center justify-center gap-4 flex-wrap">
            <a href="tel:+79929999777" className="font-roboto text-white/40 text-sm hover:text-[#FFD700] transition-colors flex items-center gap-1.5">
              <Icon name="Phone" size={13} /> +7 (992) 999-97-77
            </a>
            <span className="text-white/15">·</span>
            <a href="https://t.me/skupka24" target="_blank" rel="noreferrer" className="font-roboto text-white/40 text-sm hover:text-[#FFD700] transition-colors flex items-center gap-1.5">
          ...
          <div className="bg-[#111] border border-[#FFD700]/25 rounded-2xl p-6 max-w-sm w-full" onClick={e => e.stopPropagation()}>
            ...
            {!sent ? (
              <>
                ...
                <button onClick={handleSend} className="w-full bg-[#FFD700] text-black font-oswald font-bold text-sm uppercase py-3 rounded-lg hover:bg-yellow-400 transition-colors">
                  Перезвоните мне
                </button>
              </>
            ) : (
...
export default AncientCoinsCta;