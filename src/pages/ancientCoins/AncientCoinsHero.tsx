...
import { HERO_IMG, STATS } from "./data";

interface AncientCoinsHeroProps {
  onOpenForm: () => void;
}

const AncientCoinsHero = ({ onOpenForm }: AncientCoinsHeroProps) => {
  return (
    <>
      {/* ══ HERO ══ */}
      <section className="relative min-h-[60vh] flex items-end overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto px-4 pb-14 pt-28">
          ...
          <p className="font-roboto text-white/60 text-base md:text-lg max-w-xl mb-6 leading-relaxed">
            Покупаем римские ауреусы, греческие драхмы, монеты Киевской Руси и Парфии. Оценка за 2 часа — честная цена по международным каталогам.
          </p>
          <div className="flex flex-wrap gap-3">
            <button onClick={onOpenForm} className="inline-flex items-center gap-2 bg-[#FFD700] text-black font-oswald font-bold text-sm uppercase tracking-wide px-6 py-3 hover:bg-yellow-400 transition-colors">
...
export default AncientCoinsHero;
