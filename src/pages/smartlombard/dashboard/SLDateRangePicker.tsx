      ...
      {(showCustom || preset === "custom") && (
        <div className="bg-[#0A0A0A] border border-[#FFD700]/30 rounded-lg p-3 space-y-2 animate-in fade-in slide-in-from-top-1 duration-200">
          ...
          <div className="flex gap-1.5 flex-wrap">
            {[
              { l: "Янв 2026", from: "01.01.2026", to: "31.01.2026" },
              { l: "Фев 2026", from: "01.02.2026", to: "28.02.2026" },
              { l: "Мар 2026", from: "01.03.2026", to: "31.03.2026" },
              { l: "Апр 2026", from: "01.04.2026", to: "30.04.2026" },
              { l: "Q1 2026",  from: "01.01.2026", to: "31.03.2026" },
              { l: "2025",     from: "01.01.2025", to: "31.12.2025" },
              { l: "2024",     from: "01.01.2024", to: "31.12.2024" },
              { l: "Всё время", from: "01.01.2020", to: "31.12.2026" },
            ].map(q => (
              <button
                key={q.l}
