...
interface SovietHeroProps {
  onOpenForm: () => void;
}

const SovietHero = ({ onOpenForm }: SovietHeroProps) => {
  return (
    <>
      {/* ══ HERO ══ */}
      <section className="relative min-h-[60vh] flex items-end overflow-hidden">
        <div className="absolute inset-0">
          <img src={HERO_IMG} alt="Советский антиквариат" className="w-full h-full object-cover object-center opacity-50" />
        ...
        <div className="relative max-w-6xl mx-auto px-4 pb-14 pt-28">
          ...
          <h1 className="font-oswald font-black text-4xl md:text-6xl lg:text-7xl uppercase leading-none mb-2">СОВЕТСКИЙ</h1>
          <h1 className="font-oswald font-black text-4xl md:text-6xl lg:text-7xl uppercase leading-none mb-4">
            <span style={{
              background: "linear-gradient(90deg,#7f1d1d,#dc2626,#ef4444,#fca5a5,#ef4444,#dc2626,#7f1d1d)",
          ...
          <p className="font-roboto text-white/60 text-base md:text-lg max-w-xl mb-6 leading-relaxed">
            Покупаем ордена, плакаты, фарфор и мебель эпохи 1917–1991. Оценка за 24 часа — честная цена по аукционным результатам.
          </p>
