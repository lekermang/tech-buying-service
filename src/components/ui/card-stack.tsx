            ...
            {items.map((item, i) => {
              ...
              return (
                <motion.div
                  key={item.id}
                  className={cn(
                    "absolute bottom-0 rounded-2xl overflow-hidden shadow-2xl border border-white/10",
            ...
            return (
              <button
                ...
                className={cn(
                  ...
                  on ? "w-5 bg-white" : "w-1.5 bg-white/30 hover:bg-white/50"
                )}
  ...
  return (
    <div className="relative h-full w-full">
      ...
      <div className="relative z-10 flex h-full flex-col justify-end p-4">
        <div className={cn("font-extrabold text-white leading-none tracking-tight transition-all", active ? "text-xl" : "text-base")}>
          {item.title}
        </div>
        {item.description && (
          <div className="mt-1 text-xs text-white/60 line-clamp-1">{item.description}</div>
        )}
      </div>
    </div>
  );
