...
export const STATUSES = [
  { key: "new",              label: "Принят",          color: "bg-blue-500/20 text-blue-300",       dot: "bg-blue-400"    },
  { key: "pending_approval", label: "На согласование", color: "bg-purple-500/20 text-purple-300",   dot: "bg-purple-400"  },
  { key: "accepted",         label: "Принят мастером", color: "bg-violet-500/20 text-violet-400",   dot: "bg-violet-400"  },
  { key: "in_progress",      label: "В работе",        color: "bg-sky-500/20 text-sky-400",         dot: "bg-sky-400"     },
  { key: "waiting_parts",    label: "Ждём запчасть",   color: "bg-orange-500/20 text-orange-400",   dot: "bg-orange-400"  },
  { key: "ready",            label: "Готов",           color: "bg-yellow-500/20 text-[#FFD700]",    dot: "bg-[#FFD700]"   },
  { key: "done",             label: "Выдан",           color: "bg-green-500/20 text-green-400",     dot: "bg-green-400"   },
